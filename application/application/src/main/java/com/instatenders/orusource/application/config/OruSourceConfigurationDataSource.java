...
@EnableJpaRepositories(
        basePackages = "com.instatenders.orusource.domain.config.repositories",
        entityManagerFactoryRef = "configEntityManagerFactory",
        transactionManagerRef = "configTransactionManager"
)
public class OruSourceConfigurationDataSource {
    @Autowired
    ...
    public DataSource configDataSource() {
        DataSourceProperties dataSourceProperties = configDataSourceProperties();
    ...
    {
        EntityManagerFactory factory = configEntityManagerFactory().getObject();
    ...
    public LocalContainerEntityManagerFactoryBean configEntityManagerFactory()
    {
        ...
        factory.setDataSource(configDataSource());
        factory.setPackagesToScan(new String[]{"com.instatenders.orusource.domain.config.entities"});
