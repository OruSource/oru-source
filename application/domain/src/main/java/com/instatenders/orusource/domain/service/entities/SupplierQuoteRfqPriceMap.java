...
/**
 * The persistent class for the supplier_quote_rfq_price_map database table.
 * 
 */
@Entity
@Table(name="supplier_quote_rfq_price_map")
public class SupplierQuoteRfqPriceMap implements Serializable {
	...
	public SupplierQuoteRfqPriceMap() {
	}
