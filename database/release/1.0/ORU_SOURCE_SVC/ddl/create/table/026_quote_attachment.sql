...
CREATE TABLE quote_attachment (
	quote_attachment_id			BIGINT			NOT NULL	AUTO_INCREMENT PRIMARY KEY 	COMMENT 'Auto-generated, sequence value',
...
ALTER TABLE quote_attachment COMMENT = 'This table holds the quote attachments.';

CREATE INDEX xindx_quote_attachment
ON quote_attachment (supplier_quote_header_id);
